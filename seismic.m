function map = seismic(varargin)
%% Examples
%   seismic(5)
%   seismic(17, 'clims', [-1 1])
%   seismic(16, 'clims', [-1 2])
%   seismic(16, 'clims', [-2 1])
%   seismic(13, 'clims', [-1 2], 'mode', 'trimmed')
%   seismic(13, 'clims', [-1 2], 'mode', 'complete')
%% See also
%   disp(sprintf('"%s"\n', readlines('seismic.m')))
